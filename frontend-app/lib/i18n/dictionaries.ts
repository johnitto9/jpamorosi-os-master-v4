...
export const DICTS: Record<Lang, Dict> = {
  en: {
    navIntro: "Intro", navHall: "Hall of Fame", navFeatured: "Featured", navArchive: "Archive", navContact: "Contact",
    hallEyebrow: "Hall of Fame", hallTitle: "Flagship proof systems",
    ...
    featuredEyebrow: "Featured Systems", featuredTitle: "Systems that support the thesis",
    featuredDesc: "Substantial work reinforcing the story without competing with the flagship rooms.",
    archiveEyebrow: "Lab Archive", archiveTitle: "Experiments & artifacts",
    ...
    heroCta1: "Enter Hall of Fame", heroCta2: "Explore Project Rooms", heroCta3: "Open jpamorosi.os →",
    heroCaps: "Capabilities → proven in",
  },
  es: {
    navIntro: "Inicio", navHall: "Salón de la Fama", navFeatured: "Destacados", navArchive: "Archivo", navContact: "Contacto",
    hallEyebrow: "Salón de la Fama", hallTitle: "Sistemas insignia con prueba real",
    ...
    featuredEyebrow: "Sistemas Destacados", featuredTitle: "Sistemas que sostienen la tesis",
    featuredDesc: "Trabajo sustancial que refuerza la historia sin competir con las salas insignia.",
    archiveEyebrow: "Archivo del Lab", archiveTitle: "Experimentos y artefactos",
    ...
    heroCta1: "Entrar al Salón de la Fama", heroCta2: "Explorar las salas", heroCta3: "Abrir jpamorosi.os →",
    heroCaps: "Capacidades → probadas en",
  },
  pt: {
    navIntro: "Início", navHall: "Hall da Fama", navFeatured: "Destaques", navArchive: "Arquivo", navContact: "Contato",
    hallEyebrow: "Hall da Fama", hallTitle: "Sistemas emblemáticos com prova real",
    ...
    featuredEyebrow: "Sistemas em Destaque", featuredTitle: "Sistemas que sustentam a tese",
    featuredDesc: "Trabalho substancial que reforça a história sem competir com as salas principais.",
    archiveEyebrow: "Arquivo do Lab", archiveTitle: "Experimentos e artefatos",
    ...
    heroCta1: "Entrar no Hall da Fama", heroCta2: "Explorar as salas", heroCta3: "Abrir jpamorosi.os →",
    heroCaps: "Capacidades → provadas em",
  },
  fr: {
    navIntro: "Intro", navHall: "Hall of Fame", navFeatured: "En vedette", navArchive: "Archive", navContact: "Contact",
    hallEyebrow: "Hall of Fame", hallTitle: "Systèmes phares à preuve réelle",
    ...
    featuredEyebrow: "Systèmes en vedette", featuredTitle: "Des systèmes qui soutiennent la thèse",
    featuredDesc: "Un travail substantiel qui renforce l'histoire sans concurrencer les salles phares.",
    archiveEyebrow: "Archives du Lab", archiveTitle: "Expériences & artefacts",
    ...
    heroCta1: "Entrer au Hall of Fame", heroCta2: "Explorer les salles", heroCta3: "Ouvrir jpamorosi.os →",
    heroCaps: "Capacités → prouvées dans",
  },
  ru: {
    navIntro: "Интро", navHall: "Зал славы", navFeatured: "Избранное", navArchive: "Архив", navContact: "Контакт",
    hallEyebrow: "Зал славы", hallTitle: "Флагманские системы с реальными доказательствами",
    ...
    featuredEyebrow: "Избранные системы", featuredTitle: "Системы, подтверждающие тезис",
    featuredDesc: "Значимые работы, усиливающие историю, не конкурируя с флагманскими залами.",
    archiveEyebrow: "Архив лаборатории", archiveTitle: "Эксперименты и артефакты",
    ...
    heroCta1: "В Зал славы", heroCta2: "Смотреть залы проектов", heroCta3: "Открыть jpamorosi.os →",
    heroCaps: "Компетенции → доказаны в",
  },
  zh: {
    navIntro: "首页", navHall: "名人堂", navFeatured: "精选", navArchive: "档案", navContact: "联系",
    hallEyebrow: "名人堂", hallTitle: "旗舰级实证系统",
    hallDesc: "一间陈列奖杯的暗室。每个旗舰项目都证明一个核心命题：高级 AI 编排、生产级智能体与真实的创业执行。",
    featuredEyebrow: "精选系统", featuredTitle: "支撑命题的系统",
    featuredDesc: "扎实的作品，强化整体叙事，而不与旗舰展厅竞争。",
    archiveEyebrow: "实验室档案", archiveTitle: "实验与成果",
    ...
    heroCta1: "进入名人堂", heroCta2: "探索项目展厅", heroCta3: "打开 jpamorosi.os →",
    heroCaps: "能力 → 已验证于",
  },
  ar: {
    navIntro: "مقدمة", navHall: "قاعة المشاهير", navFeatured: "مميز", navArchive: "الأرشيف", navContact: "تواصل",
    hallEyebrow: "قاعة المشاهير", hallTitle: "أنظمة رائدة بأدلة حقيقية",
    ...
    featuredEyebrow: "أنظمة مميزة", featuredTitle: "أنظمة تدعم الأطروحة",
    featuredDesc: "أعمال جوهرية تعزز القصة دون منافسة الغرف الرائدة.",
    archiveEyebrow: "أرشيف المختبر", archiveTitle: "تجارب ومصنوعات",
    ...
    heroCta1: "ادخل قاعة المشاهير", heroCta2: "استكشف غرف المشاريع", heroCta3: "افتح jpamorosi.os ←",
...
export const ROOM: Record<Lang, RoomDict> = {
  en: {
    ...
    exploreMore: "Explore more of Amorosi Labs", backHall: "← Back to Hall of Fame",
  ...
  es: {
    ...
    exploreMore: "Explorá más de Amorosi Labs", backHall: "← Volver al Salón de la Fama",
  ...
  pt: {
    ...
    exploreMore: "Explore mais do Amorosi Labs", backHall: "← Voltar ao Hall da Fama",
  ...
  fr: {
    ...
    exploreMore: "Explorer plus d'Amorosi Labs", backHall: "← Retour au Hall of Fame",
  ...
  ru: {
    ...
    exploreMore: "Больше Amorosi Labs", backHall: "← Назад в Зал славы",
  ...
  zh: {
    ...
    exploreMore: "探索更多 Amorosi Labs", backHall: "← 返回名人堂",
  ...
  ar: {
    ...
    exploreMore: "استكشف المزيد من Amorosi Labs", backHall: "← العودة إلى قاعة المشاهير",
...
// Every preset string the lab guide speaks is here, per language. Changing the
...
export type AssistantDict = {
  ...
  panel: {
    ...
    launcherOpen: string;     // aria-label "Open lab guide"
    launcherClose: string;    // aria-label "Close lab guide"
...
export const WIZARD: Record<Lang, WizardDict> = {
  en: {
    ...
    pitchHint: "One line. What it is and for whom. The guide uses this to start the conversation.",
    ...
    needsHint: "Check what applies — the guide translates this into a real stack. No tech knowledge needed.",
  ...
  es: {
    ...
    pitchHint: "Una línea. Qué es y para quién. Lo usa el guía para arrancar la conversación.",
    ...
    needsHint: "Tildá lo que aplica — el guía traduce esto a stack concreto. No necesitás saber tecnología.",
  ...
  pt: {
    ...
    pitchHint: "Uma linha. O que é e para quem. O guia usa isso pra abrir a conversa.",
    ...
    needsHint: "Marque o que se aplica — o guia traduz isso num stack real. Não precisa saber tecnologia.",
  ...
  fr: {
    ...
    pitchHint: "Une ligne. Ce que c'est et pour qui. Le guide s'en sert pour ouvrir la conversation.",
    ...
    devPlaceholder: "ex : Next.js, Tailwind, Postgres",
    needsHint: "Cochez ce qui s'applique — le guide traduit ça en stack concret. Pas besoin de connaître la techno.",
  ...
  ru: {
    ...
    pitchHint: "Одна строка. Что это и для кого. Гид использует это, чтобы начать разговор.",
    ...
    needsHint: "Отметьте подходящее — гид переведёт это в реальный стек. Знать технологии не нужно.",
  ...
  zh: {
    ...
    pitchHint: "一句话。它是什么、为谁服务。向导会用它开启对话。",
    ...
    needsHint: "勾选适用的——向导会把它翻译成真正的技术栈。不需要懂技术。",
  ...
  ar: {
    ...
    pitchHint: "سطر واحد. ما هو ولمن. يستخدمه الدليل لبدء الحوار.",
    ...
    needsHint: "حدد ما ينطبق — يحوّله الدليل إلى تقنيات فعلية. لا حاجة لمعرفة التقنية.",
...
export const COOKIE: Record<Lang, CookieDict> = {
  en: {
    ...
    bodyTail: " on, the lab guide remembers your conversation and what you're looking for between pages. No ads, no third-party trackers.",
  ...
  es: {
    ...
    bodyTail: " activada, el guía recuerda tu conversación y lo que buscás entre páginas. Sin avisos, sin trackers de terceros.",
  ...
  pt: {
    ...
    bodyTail: " ligada, o guia lembra sua conversa e o que você procura entre páginas. Sem anúncios, sem rastreadores de terceiros.",
  ...
  fr: {
    ...
    bodyTail: " activée, le guide se souvient de votre conversation et de ce que vous cherchez d'une page à l'autre. Pas de pubs, pas de traqueurs tiers.",
  ...
  ru: {
    ...
    bodyTail: " гид запоминает ваш разговор и то, что вы ищете, между страницами. Никакой рекламы, никаких сторонних трекеров.",
  ...
  zh: {
    ...
    bodyMid: "助手记忆",
    bodyTail: " 后，向导会记住你们的对话与你在页面间寻找的内容。无广告、无第三方追踪。",
  ...
  ar: {
    ...
    bodyTail: " يتذكر الدليل محادثتك وما تبحث عنه بين الصفحات. لا إعلانات، لا متعقبات لطرف ثالث.",
  ...
  en: {
    threads: {
      omni: {
        ...
        greeting:
          "Hey! I'm Juan's lab guide 👋 Tell me what brings you here — hiring, exploring, or building something — and I'll take you straight to the proof.",
        suggestions: [
    ...
    thinking: [
      ...
      popup: {
      hello: "Hi!",
      body: "I'm Juan's lab guide. Want me to walk you through his strongest systems — or match them to what you're building?",
      ctaPrimary: "Show me around →",
      ctaSecondary: "I'll ask my own",
      dismissPreset: "Not now",
      dismissAria: "Dismiss greeting",
      dialogAria: "Assistant greeting",
    },
      panel: {
      title: "Lab guide",
      tagline: "online · answers from Juan's real work",
      closeAria: "Close chat",
      openAria: "Open lab guide",
      dockAria: "Amorosi Labs guide",
      messageAria: "Message the lab guide",
      lockedBody: "Pin a project above to unlock this space — or create a new one with +",
      lockedAction: "Open project setup",
    
        launcherOpen: "Open lab guide",
        launcherClose: "Close lab guide",
  ...
  es: {
    threads: {
      omni: {
        ...
        greeting:
          "¡Hola! Soy el guía de lab de Juan 👋 Contame qué te trae — contratar, explorar o construir algo — y te llevo directo a la prueba.",
        suggestions: [
    ...
    thinking: [
      ...
      popup: {
      hello: "¡Hola!",
      body: "Soy el guía de lab de Juan. ¿Querés que te muestre sus sistemas más fuertes — o que los cruce con lo que estás construyendo?",
      ctaPrimary: "Mostrame todo →",
      ctaSecondary: "Pregunto yo",
      dismissPreset: "Ahora no",
      dismissAria: "Cerrar saludo",
      dialogAria: "Saludo del asistente",
    },
      panel: {
      title: "Guía de lab",
      tagline: "en línea · respuestas del trabajo real de Juan",
      closeAria: "Cerrar chat",
      openAria: "Abrir guía de lab",
      dockAria: "Guía de Amorosi Labs",
      messageAria: "Escribile al guía",
      lockedBody: "Pinneá un proyecto arriba para activar este espacio — o creá uno nuevo con +",
      lockedAction: "Abrir setup de proyecto",
    
        launcherOpen: "Abrir guía de lab",
        launcherClose: "Cerrar guía de lab",
  ...
  pt: {
    threads: {
      omni: {
        ...
        greeting:
          "Olá! Sou o guia de lab do Juan 👋 Me conta o que te traz — contratar, explorar ou construir algo — e te levo direto à prova.",
        suggestions: [
          "Me dá o tour guiado",
    ...
    thinking: [
      ...
      popup: {
      hello: "Olá!",
      body: "Sou o guia de lab do Juan. Quer que eu te guie pelos sistemas mais fortes dele — ou que eu combine com o que você está construindo?",
      ctaPrimary: "Me mostra tudo →",
      ctaSecondary: "Eu pergunto",
      dismissPreset: "Agora não",
      dismissAria: "Dispensar saudação",
      dialogAria: "Saudação do assistente",
    },
      panel: {
      title: "Guia de lab",
      tagline: "online · respostas do trabalho real do Juan",
      closeAria: "Fechar chat",
      openAria: "Abrir guia de lab",
      dockAria: "Guia do Amorosi Labs",
      messageAria: "Mande mensagem ao guia",
      lockedBody: "Fixe um projeto acima para destravar este espaço — ou crie um novo com +",
      lockedAction: "Abrir setup de projeto",
    
        launcherOpen: "Abrir guia de lab",
        launcherClose: "Fechar guia de lab",
  ...
  fr: {
    threads: {
      omni: {
        ...
        greeting:
          "Salut ! Je suis le guide de lab de Juan 👋 Dis-moi ce qui t'amène — recrutement, exploration ou construction — et je t'emmène directement à la preuve.",
        suggestions: [
    ...
    thinking: [
      ...
      popup: {
      hello: "Salut !",
      body: "Je suis le guide de lab de Juan. Vous voulez que je vous fasse visiter ses systèmes les plus forts — ou que je les marie à ce que vous construisez ?",
      ...
      dialogAria: "Salutation de l'assistant",
    },
      panel: {
      title: "Guide de lab",
      tagline: "en ligne · réponses tirées du vrai travail de Juan",
      closeAria: "Fermer le chat",
      openAria: "Ouvrir le guide de lab",
      dockAria: "Guide d'Amorosi Labs",
      messageAria: "Écrire au guide",
      ...
      lockedAction: "Ouvrir la config de projet",
        ...
        launcherOpen: "Ouvrir le guide de lab",
        launcherClose: "Fermer le guide de lab",
  ...
  ru: {
    threads: {
      omni: {
        ...
        greeting:
          "Привет! Я гид по лаборатории Хуана 👋 Расскажи, что привело — найм, разведка или своя разработка — и я сразу веду тебя к доказательствам.",
        suggestions: [
    ...
    thinking: [
      ...
      popup: {
      hello: "Привет!",
      body: "Я гид по лаборатории Хуана. Хотите, проведу по его самым сильным системам — или подберу под вашу задачу?",
      ctaPrimary: "Покажи всё →",
      ctaSecondary: "Спрошу сам",
      dismissPreset: "Не сейчас",
      dismissAria: "Закрыть приветствие",
      dialogAria: "Приветствие ассистента",
    },
      panel: {
      title: "Гид лаборатории",
      tagline: "онлайн · ответы из реальной работы Хуана",
      closeAria: "Закрыть чат",
      openAria: "Открыть гид лаборатории",
      dockAria: "Гид Amorosi Labs",
      messageAria: "Написать гиду",
      ...
      lockedAction: "Открыть настройку проекта",
        ...
        launcherOpen: "打开实验室向导",
        launcherClose: "关闭实验室向导",
        newConversation: "+ 新对话",
        typing: "向导正在输入",
  ...
  zh: {
    threads: {
      omni: {
        ...
        greeting:
          "你好！我是 Juan 的实验室向导 👋 告诉我你来这里的目的——招聘、了解，还是正在构建什么——我直接带你去看实证。",
        suggestions: [
          "带我走一遍导览",
          "我在招 AI 工程",
          "给我看最强的 AI 项目",
    ...
    thinking: [
      ...
      popup: {
      hello: "你好!",
      body: "我是 Juan 的实验室向导。要我带你走一遍他最强的系统——还是按你正在做的东西匹配？",
      ctaPrimary: "带我看看 →",
      ctaSecondary: "我自己问",
      dismissPreset: "稍后",
      dismissAria: "关闭问候",
      ...
      closeAria: "关闭聊天",
      openAria: "打开实验室向导",
      dockAria: "Amorosi Labs 向导",
      messageAria: "给向导留言",
      lockedBody: "在上面固定一个项目以激活此空间——或用 + 创建一个新项目",
      lockedAction: "打开项目设置",
    
        launcherOpen: "افتح دليل المختبر",
        launcherClose: "أغلق دليل المختبر",
  ...
  ar: {
    threads: {
      omni: {
        ...
        greeting:
          "مرحباً! أنا دليل مختبر خوان 👋 أخبرني ماذا أتى بك — توظيف، استكشاف، أم بناء شيء — وسأوصلك مباشرة إلى الدليل.",
        suggestions: [
    ...
    thinking: [
      ...
      popup: {
      hello: "مرحباً!",
      body: "أنا دليل مختبر خوان. هل تريد أن أعرض عليك أقوى أنظمته — أو أن أطابقها مع ما تبنيه؟",
      ctaPrimary: "اعرض عليّ ←",
      ctaSecondary: "سأسأل بنفسي",
      dismissPreset: "ليس الآن",
      dismissAria: "إغلاق التحية",
      dialogAria: "تحية المساعد",
    },
      panel: {
      title: "دليل المختبر",
      tagline: "متصل · إجابات من عمل خوان الحقيقي",
      closeAria: "إغلاق الدردشة",
      openAria: "افتح دليل المختبر",
      launcherOpen: "افتح دليل المختبر",
      launcherClose: "أغلق دليل المختبر",
      dockAria: "دليل Amorosi Labs",
      messageAria: "راسل الدليل",
      newConversation: "+ محادثة جديدة",
      typing: "الدليل يكتب",
      removeAttachment: "إزالة المرفق",
      attachImage: "إرفاق صورة",
